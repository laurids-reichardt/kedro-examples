...
# empty_kedro_template documentation build
...
from empty_kedro_template import __version__ as release

# -- Project information -----------------------------------------------------

project = "empty_kedro_template"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "empty_kedro_templatedoc"
...
latex_documents = [
    (
        master_doc,
        "empty_kedro_template.tex",
        "empty_kedro_template Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "empty_kedro_template",
        "Project empty_kedro_template codebase.",
        "Data-Science",
    )
]
